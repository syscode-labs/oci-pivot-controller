...
import (
	...
	"github.com/syscode-labs/oci-pivot-controller/internal/controller"
...
func init() {
	...
	utilruntime.Must(pivotv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "7c3afafd.oci.io",
	...
	ociClient, err := ociutil.NewInstancePrincipalClient(compartmentID)
	if err != nil {
		setupLog.Error(err, "Failed to initialise OCI instance principal client")
		os.Exit(1)
	}

	if err := (&controller.PivotIPReconciler{
		Client:             mgr.GetClient(),
		Scheme:             mgr.GetScheme(),
		OCI:                ociClient,
		DefaultCompartment: compartmentID,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "PivotIP")
		os.Exit(1)
	}
